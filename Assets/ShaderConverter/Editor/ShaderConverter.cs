        ...
        public static string m_shaderTemplate = @"Shader ""Custom/CustomShaderName""
{
    ...
    SubShader
    {
        ...
        public static string CreateNewShaderContent(string shaderName, string renderType, string renderQueue, string cullType, string zWriteType, string zTestType, string blendType, string pragmaTarget)
        {
            ...
            newShader = Regex.Replace(newShader, "#pragma target 4.0", "#pragma target " + pragmaTarget);
        ...
        public static string AddVectorProperties(string inputShaderContent, string name, string initValue = "(0,0,0,0)")
        {
            if (initValue == string.Empty)
            {
                initValue = "(0,0,0,0)";
            }
            return AddProperties(inputShaderContent, name, "Vector", "float4", initValue);
        }

        public static string AddColorProperties(string inputShaderContent, string name, string initValue = "(0,0,0,0)")
        {
            if (initValue == string.Empty)
            {
                initValue = "(0,0,0,0)";
            }
            return AddProperties(inputShaderContent, name, "Color", "float4", initValue);
        }

        public static string AddIntProperties(string inputShaderContent, string name, string initValue="0")
        {
            if (initValue == string.Empty)
            {
                initValue = "0";
            }
            return AddProperties(inputShaderContent, name, "Int", "int", initValue);
        }

        public static string AddFloatProperties(string inputShaderContent, string name, string initValue = "0")
        {
            if (initValue == string.Empty)
            {
                initValue = "0";
            }
            return AddProperties(inputShaderContent, name, "Float", "float", initValue);
        }
